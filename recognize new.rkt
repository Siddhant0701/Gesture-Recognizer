...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname |recognize new|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;;
;; ***************************************************
...
(define c (second (first (get-points templates (list 2)))))
(get-spatial-sample (rest c) (/ (gesture-length c) (- (length c) 1))
                    (first c) 9)
...
(check-expect (spatial-rec testk templates 5) 'k)
